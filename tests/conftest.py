...
class FSAppLayoutFixture(object):
    ...
    def write_conf(self, semver_template, hotfix_template, prerelease_template, buildmetadata_template, deps, extra_info):
        with open(self.params['app_conf_path'], 'r+') as f:
            ...
            data["conf"] = {
                "semver_template": semver_template,
                "hotfix_template": hotfix_template,
                "prerelease_template": prerelease_template,
                "buildmetadata_template": buildmetadata_template,
                "deps": deps,

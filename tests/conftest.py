...
class FSAppLayoutFixture(object):
    ...
    def write_conf(self, vmn_ctx, template, deps, extra_info):
        with open(vmn_ctx.params['app_conf_path'], 'r+') as f:
        ...
        self._app_backend.add_conf_file(vmn_ctx.params['app_conf_path'])

...
echo "docker run --init -t -v ${CUR_DIR}/..:${CUR_DIR}/.. vmn_tester:ubuntu_xenial ${CUR_DIR}/run_pytest.sh"
docker run --init -t -v ${CUR_DIR}/..:${CUR_DIR}/.. vmn_tester:ubuntu_xenial ${CUR_DIR}/run_pytest.sh --skip_test test_backward_compatability_with_previous_vmn || exit 1

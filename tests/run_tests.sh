...
docker run -t -v ${CUR_DIR}/..:${CUR_DIR}/.. vmn_tester:ubuntu_bionic ${CUR_DIR}/run_pytest.sh --skip_test test_backward_compatability_with_previous_vmn || exit 1
...
docker run -t -v ${CUR_DIR}/..:${CUR_DIR}/.. vmn_tester:ubuntu_focal ${CUR_DIR}/run_pytest.sh --skip_test test_backward_compatability_with_previous_vmn || exit 1

...
class VersionControlStamper(IVersionsStamper):
    ...
    def stamp_app_version(
        ...
        old_version = self._backend.get_latest_ver(self._name)
        ...
        # TODO:: write file to disk here (last_known_version_file)
        ...
        changesets_to_commit_message = {}
        for k in flat_dependency_repos:
            if self._repo_name == k:
                changesets_to_commit_message[k] = user_repo_details[k]
                changesets_to_commit_message[k]['hash'] = \
                    self._backend.last_user_changeset()
            else:
                changesets_to_commit_message[k] = user_repo_details[k]
        ...
        self._version_info_message['stamping']['app'] = {
            ...
            "changesets": changesets_to_commit_message,
            "info": info,
        }
    ...
    def publish(self, app_version, main_version=None):
        version_files = [
            self._app_conf_path,
            #TODO:: 'latest_known_file (should be initialted like _app_conf_path in buuild world)'
        ]

...
class IVersionsStamper(object):
    ...
    def gen_app_version(
        ...
        if (initial_prerelease == "release"
                and self._release_mode is None):
            raise RuntimeError(
    ...
    def gen_vmn_version(
            ...
            hotfix=None, prerelease=None, prerelease_count={}
    ):
...
def _stamp_version(
    ...
    verstr = versions_be_ifc.gen_verstr(
        current_version,
        prerelease,
        prerelease_count
    )
